...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "GlyphViewer", None))
        self.label.setText(_translate("MainWindow", "Threshold", None))
        self.label_2.setText(_translate("MainWindow", "Vector Size:", None))
        self.vector_size.setText(_translate("MainWindow", "<No vector selected>", None))
